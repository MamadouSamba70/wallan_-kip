    ...
    _dio.interceptors.add(
      InterceptorsWrapper(
        ...
        onError: (DioException error, handler) async {
          ...
          // Ne pas tenter de rafraîchir le token si la requête elle-même est
          // déjà celle de refresh. On doit alors abandonner immédiatement.
            ...
            try {
              ...
              if (newAccessToken == null || newAccessToken.isEmpty) {
                throw DioException(
                  ...
                  error: 'Refresh token response did not contain a new access token.',
                );
              }
