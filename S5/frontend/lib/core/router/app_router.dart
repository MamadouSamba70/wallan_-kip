...
import '../../features/statistics/presentation/screens/statistics_screen.dart'; // Semaine 4/5 : Statistiques Proche
...
class AppRouter {
  static final GoRouter router = GoRouter(
    ...
    routes: [
      ...
      // Route pour le Dashboard Statistiques de l'espace Proche (Semaine 4/5)
      GoRoute(
        path: '/relative/statistics',
